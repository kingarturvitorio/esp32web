...
from .models import Campus, Status, Classe, Campo, Atividade
...
class SituacaoCreate(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        # Antes do super, atribuímos o usuário logado ao campo movimentado_por
        form.instance.movimentado_por = self.request.user

        # O objeto é salvo no banco de dados aqui
